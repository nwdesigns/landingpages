/**
 * NW Designs - Automotive Landing Page
...
(function() {
  ...
  const CustomCursor = {
    ...
    setupDarkSectionDetection() {
      ...
      // Check periodically (more efficient than on every frame)
  ...
  const FormValidation = {
    ...
    showError(fieldId) {
      ...
      // For checkbox, add error to parent label
      ...
      const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            ...
            // Check if any observed element is visible
